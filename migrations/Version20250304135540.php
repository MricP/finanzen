 ...
 */
final class Version20250304135540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liste_article (liste_id INT NOT NULL, article_id INT NOT NULL, INDEX IDX_B3009637E85441D8 (liste_id), INDEX IDX_B30096377294869C (article_id), PRIMARY KEY(liste_id, article_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE liste_article ADD CONSTRAINT FK_B3009637E85441D8 FOREIGN KEY (liste_id) REFERENCES liste (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE liste_article ADD CONSTRAINT FK_B30096377294869C FOREIGN KEY (article_id) REFERENCES article (id) ON DELETE CASCADE');
